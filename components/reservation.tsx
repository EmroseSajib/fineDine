  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (serviceId && templateId && publicKey) {
        ...
        console.log("[v0] Reservation form data:", Object.fromEntries(formData))
      }
        ...
        >
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                type="text"
                required
                className="border-b border-border bg-transparent px-0 py-3 text-foreground placeholder:text-muted-foreground/50 focus:border-primary focus:outline-none transition-colors"
              />
            </div>
            ...
            {/* Phone */}
            <div className="flex flex-col gap-2">
              <label htmlFor="phone" className="text-xs font-medium tracking-wider uppercase text-muted-foreground">
                {t("reservation.phone")}
              </label>
              <input
                id="phone"
            ...
            {/* Guests */}
            <div className="flex flex-col gap-2">
              <label htmlFor="guests" className="text-xs font-medium tracking-wider uppercase text-muted-foreground">
              ...
              <select
                ...
                name="guests"
                required
                className="border-b border-border bg-transparent px-0 py-3 text-foreground focus:border-primary focus:outline-none transition-colors"
              >
            ...
            {/* Date */}
            <div className="flex flex-col gap-2">
              <label htmlFor="date" className="text-xs font-medium tracking-wider uppercase text-muted-foreground">
                {t("reservation.date")}
              </label>
              <input
                id="date"
            ...
            {/* Time */}
            <div className="flex flex-col gap-2">
              <label htmlFor="time" className="text-xs font-medium tracking-wider uppercase text-muted-foreground">
                {t("reservation.time")}
              </label>
              <select
                id="time"
          ...
          <div className="mt-6 flex flex-col gap-2">
            ...
            <textarea
              ...
              name="message"
              rows={3}
              className="border-b border-border bg-transparent px-0 py-3 text-foreground placeholder:text-muted-foreground/50 focus:border-primary focus:outline-none transition-colors resize-none"
            />
          </div>
