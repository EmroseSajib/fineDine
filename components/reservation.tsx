...
//     // Unicode → Base64
//     const encodeUnicode = (value: string) => {
//       return btoa(
...
//     const encodedEmail = encodeUnicode(email);
//     const encodedPhone = encodeUnicode(phone);
//     const encodedMessage = encodeUnicode(note);

//     // Taurus expects YYYYMMDD
//     const formattedDate = date.replace(/-/g, "");

//     // Taurus expects HH:mm:ss.000
//     const formattedTime = `${time}:00.000`;

//     const apiUrl =
//       `https://www.aromaamoris.nl/api/reservation/` +
//       `096a08671fc84076b67e51be014fb24f/` +
//       `0/` +
//       `${formattedTime}/` +
//       `${formattedDate}/` +
//       `${guests}/` +
...
//       if (!response.ok || result?.Status === "FOUT") {
